...
import { HighlightTableView } from "@/components/highlight/HighlightTableView";
...
const Highlight = () => {
  ...
  const { highlights, loading: highlightsLoading, addHighlight, updateHighlight, deleteHighlight } = useHighlights();
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 text-lg opacity-90">
                Track important updates, strategic notes, and key business highlights
              </p>
            </div>
